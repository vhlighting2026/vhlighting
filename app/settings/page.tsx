...
export default function Page(){
  ...
  return <AuthGuard><AppShell title="Cài đặt hóa đơn"><form className="panel form-card settings-form" onSubmit={save}>
    ...
    <div className="settings-section"><h3>Nhận diện và liên hệ</h3><div className="form-grid">
      ...
      <label>Người lập phiếu<input value={form.invoice_creator||""} onChange={e=>set("invoice_creator",e.target.value)} placeholder="Vũ Lighting"/></label><label>Link logo (tùy chọn)<input value={form.logo_url||""} onChange={e=>set("logo_url",e.target.value)} placeholder="https://.../logo.png"/></label>
    </div></div>
